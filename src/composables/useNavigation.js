...
const sidebarItemsBySection = {
  ...
  catalogue: [
    ...
    { type: 'separator', label: 'Positionnement' },
    { name: 'sidebar_catalogue_positionnement', href: '/dashboard/catalogue/positionnement', icon: 'pi-compass' },
    { type: 'separator', label: 'Évaluation des acquis' },
    { name: 'sidebar_catalogue_evaluation_acquis', href: '/dashboard/catalogue/evaluation-acquis', icon: 'pi-check-circle' },
    { type: 'separator', label: 'Enquête' },
    { name: 'sidebar_catalogue_enquetes', href: '/dashboard/catalogue/enquetes', icon: 'pi-chart-bar' },
